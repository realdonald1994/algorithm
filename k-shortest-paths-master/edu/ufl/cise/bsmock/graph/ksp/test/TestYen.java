...
//        K = 5;
		...
		if(line3.equals("UNIT")) {
			...
			OUTPUTFILE="output-Yen-Unit.txt";
		}else if(line3.equals("EUCLIDEAN")){
			graphFilename = "edu/ufl/cise/bsmock/graph/ksp/test/test.txt";
			OUTPUTFILE="output-Yen-Euclidean.txt";
		}
        System.out.println("please inout original city:(like: Paris, Santa_Barbara...)");
		
		 String line =sc.nextLine();
		 sourceNode = line;
		 System.out.println("please inout destination city:(like: Shanghai, New_York...)");
...
//		K = 10;
    ...
    public static void usageExample1(String graphFilename, String source, String target, int k) throws IOException {
        ...
        wirte("edu/ufl/cise/bsmock/graph/ksp/test"+OUTPUTFILE, "\n"+"Computing the " + k + " shortest paths from [" + source + "] to [" + target + "] "+"using Yen's algorithm... ");
        List<Path> ksp;
